...
<Hero />
<div class="-mx-2.5 my-1.5 flex justify-end font-medium md:mb-6 xl:mx-0">
	<a
		href="/{lang == 'fr' ? 'realisations' : 'en/work'}"
		class="border-2 bg-white/20 px-3 py-1.5 text-sm font-bold tracking-wide uppercase transition hover:bg-black/10"
	>
...
<div
	class="mx-auto mt-24 flex max-w-[70rem] flex-col items-center justify-between gap-24 md:mt-36 md:mb-44 lg:flex-row lg:items-start lg:gap-24"
>
	<Credentials />
	<div class="max-w-[31rem] space-y-16 lg:space-y-24">
		<Testimonials />
	</div>
</div>
